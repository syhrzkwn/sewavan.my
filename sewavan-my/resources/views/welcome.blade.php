                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    @if (Route::has('login'))
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="{{ route('your-booking') }}">Your Booking</a>
                            </li>
                        </ul>
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 mt-5">
                <div class="col">
                    <div class="card bg-transparent border-0 h-100">
                        <img src="{{ url('/img/sewavan1.webp') }}" class="mx-auto" width="350px" alt="...">
                        <div class="card-body">
                            <h5 class="card-title fw-bold">Sewa Van 14 Seater</h5>
                            <p class="card-text mb-0"><i class="bi bi-truck-front"></i> Jinbei | Toyota Hiace | Lain-lain</p>
                            <p class="card-text"><i class="bi bi-gear"></i> Manual</p>
                            <hr>
                            <div class="d-flex justify-content-between align-items-end">
                                <div>
                                    <p class=" card-text mb-1">Pandu Sendiri</p>
                                    <a href="" class="btn btn-success">RM 388 / Hari</a>
                                </div>
                                <div class="text-end">
                                    <p class=" card-text mb-1">Dengan<br>Pemandu 10 Jam</p>
                                    <a href="" class="btn btn-success">RM 638 / Hari</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card bg-transparent border-0 h-100">
                        <img src="{{ url('/img/sewavan2.webp') }}" class="mx-auto" width="350px" alt="...">
                        <div class="card-body">
                            <h5 class="card-title fw-bold">Sewa Van 18 Seater</h5>
                            <p class="card-text mb-0"><i class="bi bi-truck-front"></i> Cam Placer | Lain-lain</p>
                            <p class="card-text"><i class="bi bi-gear"></i> Manual</p>
                            <hr>
                            <div class="d-flex justify-content-between align-items-end">
                                <div>
                                    <p class=" card-text mb-1">Pandu Sendiri</p>
                                    <a href="" class="btn btn-success">RM 588 / Hari</a>
                                </div>
                                <div class="text-end">
                                    <p class=" card-text mb-1">Dengan<br>Pemandu 10 Jam</p>
                                    <a href="" class="btn btn-success">RM 838 / Hari</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card bg-transparent border-0 h-100">
                        <img src="{{ url('/img/sewavan3.webp') }}" class="mx-auto" width="350px" alt="...">
                        <div class="card-body">
                            <h5 class="card-title fw-bold">Sewa Panel Van</h5>
                            <p class="card-text mb-0"><i class="bi bi-truck-front"></i> Dual Sliding Door | 6045L Ruang Cargo</p>
                            <p class="card-text"><i class="bi bi-gear"></i> Manual</p>
                            <hr>
                            <div class="d-flex justify-content-between align-items-end">
                                <div>
                                    <p class=" card-text mb-1">Pandu Sendiri</p>
                                    <a href="" class="btn btn-success">RM 150 / Hari</a>
                                </div>
                                <div class="text-end">
                                    <p class=" card-text mb-1">Dengan<br>Pemandu 10 Jam</p>
                                    <a href="" class="btn btn-success">RM 350 / Hari</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="bg-blue p-5 text-light">
            <div class="row row-cols-1 row-cols-md-2">
                ...
                <div class="col">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1991.8639387219657!2d101.69183238869985!3d3.1662176773189374!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc49f282fd2e9b%3A0x201a34f638f35d40!2sBistari%20Apartment%20Rental!5e0!3m2!1sen!2smy!4v1685459704031!5m2!1sen!2smy" width="550" height="300" style="border-radius:.5rem;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
            <p class="text-center mt-5">&copy; 2023 syhrzkwn.dev. All Rights Reserved.<br>Rev Move Berhad (1486439-U)</p>
        </footer>
    </body>
</html>
